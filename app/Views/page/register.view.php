...
<div class="container">
	<div class="row m-0 p-0">
		...
		<div class="col-6 p-5 justify-content-center">
			...
			<form class="px-5" name="signup" action="/register" method="POST">
			...
			<span class="d-flex justify-content-center">Already have an account?<a class="nav-link text-primary m-0 p-0 pl-2" href="/login">Log in</a></span>			
		</div>
