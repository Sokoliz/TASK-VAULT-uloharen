...
<header class="m-0 p-0">
	<nav class="navbar navbar-expand-lg pt-3 text-dark">
		<div class="menu container">
			...
			<!-- Logo obrázok -->
			<?php 
            // echo displayImage('logo', 'main', 'Kalendar', 'd-inline-block align-middle mr-2', ['width' => '45']);
             ?>
...
<div class="container mt-0 mb-4">
    <div class="row d-flex m-2 mt-0">
        ...
        <div class="col-sm-4 col-md-4">
            <a class="card my-card text-dark" href="/today">
                <?php 
                // echo displayImage('pages', 'today', 'Today', 'card-img-top img-rounded', ['id' => 'Panel_Image']); 
                ?>
                 <img src="/public/img/today.jpg" width="45" alt="Kalendar" class="card-img-top img-rounded" >	
        ...
        <!-- Karta pre projekty -->
        <div class="col-sm-4 col-md-4">
            <a class="card my-card text-dark" href="/projects">
                <?php 
                // echo displayImage('pages', 'projects', 'Projects', 'card-img-top img-rounded', ['id' => 'Panel_Image']);
                 ?>
                 <img src="/public/img/projects.jpg" width="45" alt="Kalendar" class="card-img-top img-rounded">	
               <div class="card-body d-flex justify-content-center">
        ...
        <!-- Karta pre kalendár -->
        <div class="col-sm-4 col-md-4">
            <a class="card my-card text-dark" href="/calendar">
                <?php 
                // echo displayImage('pages', 'calendar', 'Calendar', 'card-img-top img-rounded', ['id' => 'Panel_Image']); 
                ?>
                <img src="/public/img/calender.jpg" width="45" alt="Kalendar" class="card-img-top img-rounded">	
               <div class="card-body d-flex justify-content-center">
