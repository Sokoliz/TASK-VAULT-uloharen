 ...
 * Slovenské komentáre:
 * ===================================
 * FullCalendar je JavaScript knižnica pre vytváranie interaktívnych kalendárov 
 * na webových stránkach. Umožňuje zobrazovať a spravovať udalosti v rôznych 
 * pohľadoch (mesiac, týždeň, deň).
 * 
 * Hlavné funkcie:
 * - Zobrazenie kalendára v rôznych pohľadoch (mesačný, týždenný, denný)
 * - Drag & drop funkcionalita pre udalosti
 * - Zmena veľkosti udalostí
 * - Podpora pre opakujúce sa udalosti
 * - Lokalizácia (vrátane slovenčiny)
 * - Responzívny dizajn
 * - Integrácia s Google Calendar
 * - Prispôsobiteľný vzhľad pomocou CSS
 * 
 * FullCalendar využíva jQuery a Moment.js pre svoje fungovanie.
 * Je ideálny pre aplikácie na plánovanie a správu udalostí.
 * ===================================
 */

/*
 * FullCalendar využíva tieto hlavné komponenty:
 * 
 * 1. Calendar - Hlavný objekt pre vytváranie a konfiguráciu kalendára
 * 2. View - Rôzne pohľady (mesačný, týždenný, denný)
 * 3. Event - Reprezentácia udalostí v kalendári
 * 4. EventSource - Zdroj dát pre udalosti
 * 5. EventRenderer - Zodpovedný za vykresľovanie udalostí
 * 6. Grid - Základná mriežka kalendára
 * 7. TimeGrid - Špeciálna mriežka pre časové pohľady
 * 8. DayGrid - Špeciálna mriežka pre denné pohľady
 */
